...
export default function ApplyVacationPage() {
  ...
  const validate = () => {
    ...
    if (!user?.department) {
      toast.error("You must be assigned to a department to apply for vacation");
      return false;
    }
    ...
    if (formData.startDate && formData.endDate) {
      ...
      if (isWeekend(start)) {
        newErrors.startDate =
          "Start date cannot be a weekend (Friday or Saturday)";
      }
      ...
      if (isWeekend(end)) {
        newErrors.endDate = "End date cannot be a weekend (Friday or Saturday)";
      }
    }
    ...
    if (workingDays > 0 && summary) {
      ...
      if (workingDays > balanceToCheck) {
        newErrors.endDate = `Insufficient ${
          formData.isRewardVacation ? "reward" : "annual"
        } vacation balance (Available: ${balanceToCheck} days, Requested: ${workingDays} days)`;
      }

      if (workingDays === 0) {
        newErrors.endDate = "Selected date range has no working days";
      }
    }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!departmentId) {
      toast.error(
        "Department information is missing. Please contact administrator."
      );
      return;
    }
    ...
    try {
      ...
      toast.error(error?.data?.message || "Failed to apply for vacation");
    }
  };
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-gray-900">Apply for Vacation</h1>
        <p className="text-gray-600 mt-1">
          Submit a vacation application for approval
        </p>
      </div>
              ...
              <div className="relative overflow-hidden">
                ...
                <div className="space-y-2">
                  <div className="flex items-baseline gap-2">
                    ...
                    <span className="text-sm text-gray-500">/ 21 days</span>
                  </div>
                  <div className="w-full bg-gray-200 rounded-full h-2">
                    <div
                      className="bg-blue-600 h-2 rounded-full transition-all duration-300"
                      style={{
                        width: `${(summary.annualVacationBalance / 21) * 100}%`,
                      }}
                    ></div>
                  </div>
                  {!formData.isRewardVacation && workingDays > 0 && summary && (
                    <div className="pt-2 border-t border-blue-100">
                      <p className="text-xs text-gray-600 flex justify-between">
                        ...
                        >
                          {(summary.annualVacationBalance || 0) - workingDays}{" "}
                          days
                        </span>
                      </p>
                    </div>
              ...
              <div className="relative overflow-hidden">
                <div className="flex items-start justify-between mb-3">
                  <div className="flex items-center gap-2 text-amber-600">
                    ...
                    <span className="text-sm font-semibold">Reward Days</span>
                  </div>
                  {formData.isRewardVacation && workingDays > 0 && (
                ...
                <div className="space-y-2">
                  <div className="flex items-baseline gap-2">
                    ...
                    <span className="text-sm text-gray-500">days earned</span>
                  </div>
                  {summary.rewardVacationBalance > 0 ? (
                    <div className="flex gap-1">
                      {[
                        ...
                        <GiftIcon key={i} className="w-4 h-4 text-amber-500" />
                      ))}
                    ...
                    <p className="text-xs text-gray-500 italic">
                      Earn 1 day/month without annual vacation
                    </p>
                  )}
                  {formData.isRewardVacation && workingDays > 0 && summary && (
                    <div className="pt-2 border-t border-amber-100">
                      <p className="text-xs text-gray-600 flex justify-between">
                        ...
                        >
                          {(summary.rewardVacationBalance || 0) - workingDays}{" "}
                          days
                        </span>
                      </p>
                    </div>
            ...
            <Card>
              <div className="relative overflow-hidden">
                <div className="flex items-center gap-2 text-purple-600 mb-3">
                  ...
                  <span className="text-sm font-semibold">Total Available</span>
                </div>
                <div className="space-y-2">
                  <div className="flex items-baseline gap-2">
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="text-sm text-gray-700 space-y-1">
                ...
                <ul className="list-disc list-inside space-y-0.5 ml-2 text-xs">
                  <li>
                    <strong className="text-blue-700">Annual Vacation:</strong>{" "}
                  ...
                  <li>Only working days count (Friday & Saturday excluded)</li>
                  <li>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-5 border border-gray-200 shadow-sm">
                ...
                <div className="grid grid-cols-3 gap-3 mb-4">
                  ...
                  <div className="bg-green-50 rounded-lg p-3 text-center border border-green-200">
                    ...
                    <p className="text-xs text-green-700 mt-1">Working Days</p>
                  </div>
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Please provide a detailed reason for your vacation request"
              required
            />
            {errors.reason && (
          ...
          <div className="flex gap-3">
            ...
            >
              {isLoading
                ? "Submitting..."
                : workingDays > 0
                ? `Submit ${workingDays}-Day Vacation Request`
          ...
          {workingDays === 0 && formData.startDate && formData.endDate && (
            <div className="text-center">
              <p className="text-sm text-red-600 flex items-center justify-center gap-2">
                ...
                Selected date range contains only weekends. Please choose dates
                with working days.
              </p>
            </div>
          )}
